...
func (eb *EventBus) QueueSubscribe(channelName string, queueName string, fn func(*stan.Msg)) (stan.Subscription, error) {

	sub, err := eb.client.QueueSubscribe(channelName, queueName, fn, stan.SetManualAckMode())
	if err != nil {
		return nil, err
	}
